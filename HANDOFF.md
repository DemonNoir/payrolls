...
## 🟢 Current State
- **เวอร์ชันล่าสุด:** `?v=26` (Network-First Strategy)
...
2. **อย่าลืม Bump Version:** ทุกครั้งที่มีการแก้โค้ด JS/CSS จะต้องไปเปลี่ยน `?v=XX` ใน `index.html` และเปลี่ยนตัวแปร `CACHE` ใน `sw.js` เสมอ เพื่อบังคับให้ผู้ใช้บนมือถือโหลด Cache ใหม่ (ปัจจุบัน v26)
